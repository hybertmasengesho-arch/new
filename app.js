...
const accountShareRoutes = require('./routes/account-share');
const publicRoutes = require('./routes/public');
const tracksRoutes = require('./routes/tracks');
const shareTargetRoutes = require('./routes/share-target');
const notificationsRoutes = require('./routes/notifications');
const pushRoutes = require('./routes/push');
const searchLogRoutes = require('./routes/search-log');
...
app.use('/api/screenshare', screenshareRoutes);
app.use('/api/account-share', accountShareRoutes);
app.use('/api/public', publicRoutes);
app.use('/api/tracks', tracksRoutes);
app.use('/api/share-target', shareTargetRoutes);
